...
<section class="container pt-3 mb-3">
    <h2 class="h3 block-title text-center"><small>What we do, Whatever we do, we do with your end user in mind </small></h2>
        ...
        <div class="col-lg-4 col-sm-6 mb-30 pb-5">
            <a class="card" href="#">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="card-text text-sm">We create the prototype for you</p>
        ...
        <div class="col-lg-4 col-sm-6 mb-30 pb-5">
            <a class="card" href="#">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="card-text text-sm">We use the best and most modern designs for your web</p>
                    <!-- <span class="text-sm text-uppercase font-weight-bold">Learn More&nbsp;<i class="fe-icon-arrow-right"></i></span> -->
                </div>
            </a>
        </div>
        <div class="col-lg-4 col-sm-6 mb-30 pb-5">
            <a class="card" href="#">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="card-text text-sm">Using the best frameworks and languages</p>
                    <!-- <span class="text-sm text-uppercase font-weight-bold">Learn More&nbsp;<i class="fe-icon-arrow-right"></i></span> -->
                </div>
            </a>
        </div>
        <div class="col-lg-4 col-sm-6 mb-30 pb-5">
            <a class="card" href="#">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="card-text text-sm">The most powerful backend languages</p>
                    <!-- <span class="text-sm text-uppercase font-weight-bold">Learn More&nbsp;<i class="fe-icon-arrow-right"></i></span> -->
                </div>
            </a>
        </div>
        <div class="col-lg-4 col-sm-6 mb-30 pb-5">
            <a class="card" href="#">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="card-text text-sm">The best testing method for measuring how easy and user-friendly your web page can be</p>
                    <!-- <span class="text-sm text-uppercase font-weight-bold">Learn More&nbsp;<i class="fe-icon-arrow-right"></i></span> -->
                </div>
            </a>
        </div>
